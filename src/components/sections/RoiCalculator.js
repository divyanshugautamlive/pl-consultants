    ...
    <div className="space-y-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 bg-navy text-white rounded-2xl p-8 card-shadow border border-navy-light relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-2xl font-serif font-bold text-white mb-2">Shopfloor ROI Calculator</h3>
          ...
          {calculated ? (
            <div className="bg-white rounded-2xl p-8 border border-gray-150 card-shadow h-full space-y-8 animate-fadeIn">
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center">
                <Button href="#assessment-form" variant="primary" className="w-full sm:w-auto py-3">
      ...
      <div className="border-t border-gray-150 pt-20">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h3 className="text-3xl sm:text-4xl font-serif font-bold text-navy">
          ...
          {resourcesData.map((res) => (
            ...
            >
              <div>
                ...
                <p className="text-steel-light text-xs leading-relaxed mb-6">{res.description}</p>
              </div>
