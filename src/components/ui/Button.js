...
export default function Button({
  ...
  const variants = {
    primary:
      "bg-navy text-white hover:bg-navy-light font-bold shadow-md focus:ring-4 focus:ring-navy/20",
    secondary:
      "border-2 border-teal text-teal hover:bg-teal hover:text-white focus:ring-4 focus:ring-teal/20",
    gold:
      "bg-gold text-white hover:bg-gold-dark font-bold shadow-md hover:shadow-lg focus:ring-4 focus:ring-gold/20",
    white:
